...
class Ticket(db.Model):
    ...
    id_status = db.Column(db.Integer, db.ForeignKey('ticket_status.id'), nullable=False)
    id_urgency = db.Column(db.Integer, db.ForeignKey('ticket_urgency.id'), nullable=False)
